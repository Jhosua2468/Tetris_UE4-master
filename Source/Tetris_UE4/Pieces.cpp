...
APieces::APieces()
{
    ...
    struct FConstructorStatics
    {
        ...
        FConstructorStatics()
            ...
            , Color_7(TEXT("Material'/Game/Materials/M_Tech_Hex_Tile_Pulse.M_Tech_Hex_Tile_Pulse'"))
            , Color_8(TEXT("Material'/Game/Materials/M_Metal_Gold.M_Metal_Gold'"))
            , Color_9(TEXT("Material'/Game/Mesh/Material_9.Material_9'"))
            , Color_10(TEXT("Material'/Game/Materials/M_Brick_Cut_Stone.M_Brick_Cut_Stone'"))
...
void APieces::SpawnBlocks()
{
    std::vector<std::vector<std::pair<float, float>>> Shapes =
    {
        ...
        //
        {{30.0,10.0},{20.0,20.0},{10.0,0.0}},
        {{-10.0,0.0},{0.0,0.0}},
        {{20.0,10.0},{-20.0,10.0},{-10.0,10.0},{10.0,10.0}},
        {{-10.0,10.0},{0.0,0.0}},
         //{ {2.5,0.0},{-2.5,0.0},{0.0,1.5},{0.0,1.0},{-2.5,1.5},{2.5,1.5} },
    };
    Indice;
    //const int Index = FMath::RandRange(0, Shapes.size()-1);
    UE_LOG(LogTemp, Warning, TEXT("indice=%d"), Indice);
    const std::vector<std::pair<float, float>>& YZs = Shapes[Indice];
    for(auto&& YZ: YZs)
    {
        FRotator Rotation(0.0, 0.0, 0.0);
        ABlock* B = GetWorld()->SpawnActor<ABlock>(this->GetActorLocation(), Rotation);
        B->Mesh->SetMaterial(1, Colors[Indice]);
        Blocks.Add(B);
